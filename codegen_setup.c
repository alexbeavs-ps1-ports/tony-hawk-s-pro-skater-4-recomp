...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "Tony Hawks Pro Skater 4",
    .project_root_env = "TONY_HAWKS_PRO_SKATER_4_RECOMP_PROJECT_ROOT",
    .build_dir_env = "TONY_HAWKS_PRO_SKATER_4_RECOMP_BUILD_DIR",
    .force_setup_env = "TONY_HAWKS_PRO_SKATER_4_RECOMP_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SLUS_014.85_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "Tony_Hawks_Pro_Skater_4_Recompiled",
    .prepare_note =
